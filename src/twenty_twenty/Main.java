...
import twenty_nineteen.CrpLine;
...
// NOTES
// 2019 MN CRP PDF WAS SO SIMILAR TO 2020 THAT NO CODING NEEDED TO BE COMPLETED.

public class Main {

    private static final String BASE_CRP         = "C:/dev/fillable-pdf/pdf_filler/base_crp/2020_base_crp.pdf";
    private static final String TENANT_CRP_DATA  = "C:/dev/fillable-pdf/pdf_filler/csv_data/2020_example_list.csv";
...
//        String cvsSplitBy = "\\|";
    ...
    public static double manipulatePdf(CrpLine crpLine) throws DocumentException, IOException {
        ...
        // USED FOR NUMBERING FIELDS IF YOU ARE DEBUGGING! CHANGE FALSE TO TRUE
        Boolean PRINT_FILLABLE_PDF_BOX_ORDER_NUMBER = Boolean.FALSE;
        if(PRINT_FILLABLE_PDF_BOX_ORDER_NUMBER) {
